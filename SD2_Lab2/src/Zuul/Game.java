...
public class Game 
{
	...
	{        
		...
		player1 = new Player(currentRoom, name);
	}
	...
	private void printWelcome()
	{
		...
		System.out.println();
		System.out.println("Hello, " + player1.getName() + "You are now in " + player1.getRoom());
	}
	...
	protected void goRoom(Command command) 
	{
		...
		if (nextRoom == null) {
			...
			System.out.println(player1.getName() + " You are now in " + player1.getRoom());
		}
	}
